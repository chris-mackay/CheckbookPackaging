...
AppName=Checkbook
AppCopyright=Copyright © 2016-2021 Christopher Mackay
AppVersion=1.6.7
VersionInfoVersion=1.6.7
AppVerName=Checkbook
AppPublisher=Christopher Mackay
AppPublisherURL=https://chris-mackay.github.io/CheckbookWebsite/
AppSupportURL=https://chris-mackay.github.io/CheckbookWebsite/checkbook_help/checkbook_help.html
AppUpdatesURL=github.com/chris-mackay/Checkbook/releases/tag/v1.6.6
